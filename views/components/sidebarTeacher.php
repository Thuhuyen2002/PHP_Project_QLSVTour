    ...
    <div class='sidebar'>
        <div>
            ...
            <div class="sidebar-nav">
                <ul>
                    <li>
                        <a href="/index.php?controller=TeacherHomeController">
                    ...
                    <li>
                        <a href="/index.php?controller=EvaluateStudentController">
                    ...
                    <li>
                        <a href="/index.php?controller=TeacherChangeInforController">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <li>
                        <a href="/index.php?controller=TeacherChangePasswordController">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
