    ...
    <div class='sidebar'>
        <div>
            ...
            <div class="sidebar-nav">
                <ul>
                    <li>
                        <a href="/index.php?controller=HomeController">
                    ...
                    <li>
                        <a href="/index.php?controller=StudentRegisterTourController">
                    ...
                    <li>
                        <a href="/index.php?controller=StudentDeleteTourRegistrationController">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
                    ...
                    <li>
                        <a href="/index.php?controller=StudentTourHistoryController">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
                    ...
                    <li>
                        <a href="/index.php?controller=StudentChangeInforController">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <li>
                        <a href="/index.php?controller=StudentChangePasswordController">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
